...
const AppFileUploader = ({ type=['*/*'], multiple=false, ...rest}) => { 
    ...
    const upload_file = async () => {
        ...
        if(selected_files) {
            ...
            const res = await API.make_request(
  ...
  return (
    <View>
      <Button onPress={pick_document}>{APP._('FILE_UPLOADER.PICK_DOCUMENT')}</Button>
      ...
      <Button onPress={upload_file}>{APP._('FILE_UPLOADER.UPLOAD_SINGLE_FILE')}</Button>
    </View>
  )
}
