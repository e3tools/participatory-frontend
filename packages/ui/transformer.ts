import { 
    ...
    ISectionBreakProps,
    ILinkProps,
    ILinkedFieldProps} from "./interfaces/inputs"; 
...
class Transformer {
    ...
    static _link_props(field_cfg: object) : ILinkProps {
        let cfg = this._base_transform(field_cfg) as IBaseFieldProps;
        let dst = {} as ILinkProps;
        Object.assign(dst, cfg);
        dst.on_change = () => {};
        let opts = field_cfg.options;
        dst.options = opts ? (opts instanceof Array ? opts : opts.split('\n')) : [];
    ...
    static _linked_field_props(field_cfg: object) : ILinkedFieldProps {
        let cfg = this._base_transform(field_cfg) as IBaseFieldProps;
        let dst = {} as ILinkedFieldProps;
        Object.assign(dst, cfg);
        dst.linked_field = field_cfg.field_linked_field;
        dst.on_change = () => {};
        return dst;
    }
    ...
    static _section_break_props(field_cfg: object) : ISectionBreakProps {
        let cfg = this._base_transform(field_cfg) as IBaseFieldProps;
        let dst = {} as ISectionBreakProps;
        Object.assign(dst, cfg);
        dst.on_change = () => {};
        return dst;
    }
    ...
    static transform_field(field_cfg: object) {
        ...
        switch (field_type){ 
            ...
            case FIELD_TYPE.LINK:
                props = Transformer._link_props(field_cfg) as ILinkProps;
            break;

            case FIELD_TYPE.LINKED_FIELD:
                props = Transformer._linked_field_props(field_cfg) as ILinkedFieldProps;
            break;
            ...
            case FIELD_TYPE.SECTION_BREAK:
                props = Transformer._section_break_props(field_cfg) as ISectionBreakProps;
            break;
