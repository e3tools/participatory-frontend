...
import AppMap from 'gis/components/map' 
import { IImageOverlayProps, IMarkerProps } from '../interfaces'
import { Button, Card, IconButton } from 'react-native-paper'
import LinkField from 'ui/components/form/controls/link'
import AppSelect from 'ui/components/form/controls/select'
import { VectorService } from '../../../services/vector'
import { APP } from 'common'
import { useNavigation } from 'expo-router'
import { KENYA_BOUNDING_BOX } from '@/app/constants/enums'
...
export default function Diagnostics() {
  ...
  // Kenya bounding box
  const initial_bounds = KENYA_BOUNDING_BOX;// [33.89, -4.68, 41.86, 5.51]; 
