...
const en: Translation = {
    ...
    GLOBAL: {
        ...
        NEW_DOCTYPE: 'new',
        SAVE_SUCCESS_MESSAGE: 'Record submitted successfully',
        SAVE_ERROR_MESSAGE: 'Record was not submitted',
        SEARCH_PLACEHOLDER: 'Search here...',
        FILE_SIZE_EXCEEDED_ERROR:
            'File size limit exceeded. Please select a file up to ',
        NEW_RECORD_ID: 'New',
        DROPDOWN_PLACEHOLDER: 'Select item',
        ...
        NOT_IMPLEMENTED_IN_OFFLINE:
            'This functionality is not supported in offline mode.',
        LOADING: 'Loading...',
    ...
    SUCCESS_SAVE_PAGE: {
        ...
        SAVE_SUCCESS_MESSAGE: 'Record Submitted Successfully',
        BUTTON: {
            SAVE_ANOTHER_RECORD: 'Save Another Record',
            BACK_TO_ENGAGEMENTS: 'Back To Engagements',
        },
    },
    ENGAGEMENT_LIST_PAGE: {
        ...
        INTRODUCTION:
            'To complete a submission, select one of the engagements below and click on the Add New button',
        NO_DATA: 'No active engagements',
        NO_DRAFT_SUBMISSIONS: 'All data has been submitted',
        BUTTON: {
            EXPLORE: 'Explore',
    ...
    CHILD_TABLE: {
        NO_DATA: 'No data',
        EDITING_ROW: 'Editing Row #{{rowNumber}}',
        INSERT: 'Insert',
    },
    MAP_PAGE: {
        TITLE: 'Diagnostics',
        ...
        OPTIONS: 'Options',
        INTRODUCTION:
            'Click anywhere on the map to view recommended sustainable land management practices',
        SWIPE: 'Swipe to see more images',
        MESSAGES: {
            NO_SELECTED_ADMIN: 'Please select a region',
            SLM_ENABLED:
                'SLM querying enabled. Click any point on the map to query interventions',
    ...
    BASE_CONTROLS: {
        ...
        MAX_FILE_SIZE_EXCEEDED:
            'File selected is too big. File size must be less than ',
    },
    FILE_UPLOADER: {
