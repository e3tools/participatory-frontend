...
export default function DrawerMenu(props: any) {
  ...
  const auth = useAuth();
  const isAuthenticated = useAuthSelector((state) => state.user?.loggedInUser !== null);
  const close_drawer = () => {
    ...
    >
        <DrawerContentScrollView {...props}>
          ...
          <List.Item 
            ...
            left={props => <List.Icon {...props} icon='map-marker-distance' />}
            onPress={()=>{
              APP.navigate_to_path(props.navigation, 'modules/diagnostics/screens/diagnostics_screen', {});
            }}
            onLongPress={()=>{}}
          />
