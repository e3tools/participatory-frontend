...
import OnlineStatus from './network/online_status'
import { Button, Modal, PaperProvider, Portal } from 'react-native-paper';
import AppLoader from 'ui/components/shared/app_loader';
import { full_sync, down_sync } from  '../utils/data_sync';
...
const SynchronizeData = ({isOnline} : {isOnline: boolean }/*props: SyncDataProps*/) => {
