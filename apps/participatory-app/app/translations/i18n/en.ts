export default {
  ...
  "GLOBAL": {
      ...
      "WARNING": "Warning",
      "BETA_WARNING":"This website is under active development and everything is subject to change. We can't guarantee for the safety and privacy of the data you enter (but we try our best).",
      ...
      "NEW_DOCTYPE": "new",
      "SAVE_SUCCESS_MESSAGE": "Record submitted",
      "SAVE_ERROR_MESSAGE": "Record was not submitted",
      "SEARCH_PLACEHOLDER": "Search here...",
      "FILE_SIZE_EXCEEDED_ERROR": "File size limit exceeded. Please select a file up to ",
      "NEW_RECORD_ID": "New",
      "DROPDOWN_PLACEHOLDER": "Select",
      "DELETE_NOT_EXIST": "The record does not exist",
      "ONLINE_STATUS": "You are connected to the server",
      "OFFLINE_STATUS": "You are not connected to the server",
      "SYNC_START": "Start sync",
      "SYNC_IN_PROGRESS": "Data sync is in progress. Please wait...",
      "SYNC_COMPLETED": "Data sync completed",
      "NOT_IMPLEMENTED_IN_OFFLINE": "This functionality is not supported in offline mode."
  },
  "LOGIN_PAGE": {
      "TITLE": "Welcome back!",
      "EMAIL": "Mail",
