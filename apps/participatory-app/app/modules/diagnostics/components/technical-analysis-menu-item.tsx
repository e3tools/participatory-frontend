...
import { Button, Menu, Text, List, Checkbox } from 'react-native-paper';
import { IMappingOptionMenuItemProps } from '../interfaces';
import { IMenuProps } from 'ui/components/shared/app-menu';
import AppSlider from 'ui/components/shared/app-slider';
  ...
  return (
    ...
    >
      <Menu
        ...
        anchor={
          <Button icon="cog" mode="text" onPress={open_menu}>
            {props.anchor_label}
          </Button>
        }
        //anchor={props.anchor}
 ...
 * @returns
 */
export const TechnicalAnalysisMenuItem = (
  props: IMappingOptionMenuItemProps,
) => {
  const { title, onCheckboxValueChange, isDivider, onSliderValueChange } =
    props;
