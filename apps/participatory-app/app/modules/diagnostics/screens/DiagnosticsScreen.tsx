...
// import { KENYA_BOUNDING_BOX } from 'gis/enums';// '@/app/constants/enums'

export default function DiagnosticsScreen() {
  const navigation = useNavigation();

  const [, set_admins] = useState([]);
  const [selected_admin] = useState(null);
  const map_ref = useRef<typeof AppMap>(null);
  ...
  // Kenya bounding box
  const initial_bounds = CONFIG.KENYA_BOUNDING_BOX; // [33.89, -4.68, 41.86, 5.51];
  ...
  const select_admin = (admin) => {
    ...
    map_ref?.current
      ?.select_feature(admin.name, admin.level, null)
      .then(() => {});
  };
  useEffect(() => {
    // const region = {
      ...
      features: [
        {
          ...
          geometry: {
            coordinates: [
              [
                [145.74815454298198, -28.515687508471423],
                [145.33350465561375, -32.06616241874832],
                [149.40407262757373, -32.02001652514164],
                [152.07265745399468, -28.648668948259136],
                [151.14205415620143, -26.114295095630098],
                [145.74815454298198, -28.515687508471423],
              ],
            ],
            type: 'Polygon',
  ...
  return (
    <View>
      ...
      <PageIntro text={APP._('MAP_PAGE.INTRODUCTION')}></PageIntro>
      <AppMap
