...
See https://github.com/expo/expo/issues/16239

Metro does not make this very easy because it doesn't support symlinks. a couple alternatives:

1. run npm pack inside of your library and then npm install path/to/the/packed/file.tgz from your project
2. use a monorepo: https://docs.expo.dev/guides/monorepos/